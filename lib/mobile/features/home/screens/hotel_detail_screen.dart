...
class _HotelDetailScreenState extends State<HotelDetailScreen> {
  ...
  void initState() {
    super.initState();
    _roomsFuture = context.read<HomeProvider>().getRoomsForHotel(
      widget.hotelId,
    );
  }
  ...
  Widget _roomCard(BuildContext context, Room room) {
    final amenityText =
        room.amenities?.isNotEmpty == true
            ? room.amenities!.take(3).map((a) => '• ${a.name}').join('  ')
            : '• Wifi  • AC';
            ...
            Container(
              ...
              child:
                  room.coverImageUrl != null
                      ...
                      : const Icon(Icons.bed, color: AppColors.textPrimary),
            ),
